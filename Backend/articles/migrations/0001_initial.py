    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_U', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='articles.user')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('id_U', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='articles.user')),
            ],
        ),
        migrations.CreateModel(
            name='Pereti',
